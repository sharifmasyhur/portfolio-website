  ...
  const experiences = [
    {
      ...
      location: "Remote",
      description:
        "Community of Google Cloud Innovator, Android Studio user, enrolled in Cloud Engineer/IAM learning path.",
    },
    {
      ...
      description:
        "Assisted in media content creation according to organizational needs. Previously served as a member volunteering for open events.",
    },
    {
      ...
      description:
        "Responsible for archived documentation, coordinating asset use and maintenance, and managing meeting attendance.",
    },
  ];
  ...
  const skills = [
    {
      ...
      description:
        "Design, implementation, and management of complex network systems",
    },
    {
      icon: <Shield className="w-8 h-8 mb-4 text-purple-600" />,
      title: "System Security",
      description:
        "Ensuring reliability and security through cutting-edge technologies",
    },
    {
      icon: <Code className="w-8 h-8 mb-4 text-green-600" />,
      title: "Virtualization",
      description:
        "Experience in designing and implementing virtualized environments",
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-600 via-purple-600 to-blue-800 relative overflow-hidden">
      ...
      <section className="pt-32 pb-20 text-white text-center relative z-10">
        <div className="max-w-6xl mx-auto px-6">
          <div className="mb-6">
            ...
            <p className="text-2xl md:text-3xl mb-2 text-blue-200 font-light">
              (Saf)
            </p>
          </div>

          <p className="text-xl md:text-2xl mb-12 max-w-4xl mx-auto text-blue-100 leading-relaxed">
            Technology Enthusiast & Network Specialist driven by cutting-edge
            technological advancements and passionate about network
            infrastructure, system security, and continuous learning.
          </p>
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 transform hover:scale-105 transition-all duration-500">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-6 text-lg text-gray-600 leading-relaxed">
                <p>
                  I'm driven by a desire to learn about cutting-edge
                  technological advancements and expand my knowledge of science.
                  I'm committed to staying informed about the latest
                  developments in technology and utilizing this information to
                  achieve significant results.
                </p>
                <p>
                  I have a strong interest in developing and managing network
                  infrastructure, ensuring system security and reliability
                  through cutting-edge technologies. With experience in
                  designing networks, virtualization, and troubleshooting, I
                  continue to deepen my understanding of complex network
            ...
            <div className="space-y-8">
              <div className="group bg-gradient-to-r from-blue-50 to-purple-50 p-8 rounded-2xl hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                <div className="flex flex-wrap justify-between items-start mb-6">
                  ...
                  <span className="text-gray-500 font-medium bg-blue-100 px-4 py-2 rounded-full">
                    2022 - Present
                  </span>
                </div>
                <div className="space-y-4 text-gray-600">
                  ...
                  <div className="space-y-3 ml-4">
                    <div className="flex items-start">
                      ...
                      <span>
                        Enrolled in Progate x FTUI Bootcamp learning JavaScript
                        development
                      </span>
                    </div>
                    <div className="flex items-start">
                      <div className="w-2 h-2 bg-blue-500 rounded-full mt-3 mr-4 flex-shrink-0"></div>
                      <span>
                        Member of Majelis Permusyawaratan Mahasiswa FTUI as
                        internal staff
                      </span>
                    </div>
                    <div className="flex items-start">
                      <div className="w-2 h-2 bg-blue-500 rounded-full mt-3 mr-4 flex-shrink-0"></div>
                      <span>
                        Participated in Karirlab for career and professional
                        development
                      </span>
                    </div>
                  </div>
              ...
              <div className="group bg-gradient-to-r from-purple-50 to-blue-50 p-8 rounded-2xl hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                <div className="flex flex-wrap justify-between items-start mb-4">
                  <div>
                    ...
                    <h4 className="text-xl text-purple-600 font-semibold">
                      High School
                    </h4>
                  </div>
                  <span className="text-gray-500 font-medium bg-purple-100 px-4 py-2 rounded-full">
                    Graduated
                  </span>
                </div>
                <p className="text-gray-600 leading-relaxed text-lg">
                  Active participant in taekwondo for one year and involved in
                  physics and science projects management, developing both
                  physical discipline and scientific analytical skills.
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="projects" className="py-20 relative z-10">
        <div className="max-w-6xl mx-auto px-6">
          <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12">
            ...
            <div
              className="group relative bg-gradient-to-br from-green-50 to-blue-50 p-8 rounded-2xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 border-2 border-green-200 hover:border-green-300 cursor-pointer"
              onClick={() =>
                window.open("https://terrataste.netlify.app", "_blank")
              }
            >
              ...
              <div className="flex flex-wrap justify-between items-start mb-6">
                <div>
                  <h3 className="text-4xl font-bold text-gray-800 mb-3 group-hover:text-green-600 transition-colors duration-300">
                    TerraTaste
                  </h3>
                  <h4 className="text-xl text-green-600 font-semibold">
                    Tech Innovation Project • Live Application
                  </h4>
                  <p className="text-sm text-green-700 font-medium mt-1">
                    🌐 Click anywhere to visit live site
                  </p>
                </div>
                <span className="text-gray-500 font-medium bg-green-100 px-4 py-2 rounded-full">
                  Sep 2024 - Dec 2024
                </span>
              </div>
              ...
              <div className="space-y-6 text-gray-600 leading-relaxed">
                <div className="bg-white p-6 rounded-xl border-l-4 border-green-400">
                  ...
                  <p className="text-lg">
                    TerraTaste envisions being a catalyst for positive change in
                    the food industry through technology. We aim to shape a
                    future where innovation and creativity know no bounds, and
                    where individuals are empowered to make environmentally
                    conscious decisions about their food.
                  </p>
                </div>
                ...
                <div className="bg-white p-6 rounded-xl border-l-4 border-blue-400">
                  ...
                  <p className="text-lg">
                    To be recognized as a global leader in tech innovation,
                    known for our commitment to excellence, collaboration, and
                    social responsibility. We aspire to encourage the shift
                    toward a plant-based diet by promoting environmentally
                    friendly food choices that benefit both individuals and the
                    planet.
                  </p>
                </div>
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="group bg-gradient-to-br from-purple-50 to-blue-50 p-8 rounded-2xl hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border border-purple-200">
                <h3 className="text-2xl font-bold text-gray-800 mb-3">
                  Design and Publication Media
                </h3>
                <h4 className="text-purple-600 font-semibold mb-4 text-lg">
                  Asyraaf UI
                </h4>
                <p className="text-gray-600 leading-relaxed text-lg">
                  Actively participated in the creation of publications and
                  event information, contributing to community engagement and
              ...
              <div className="group bg-gradient-to-br from-blue-50 to-green-50 p-8 rounded-2xl hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border border-blue-200">
                <h3 className="text-2xl font-bold text-gray-800 mb-3">
                  GDSC #JuaraGCP Participant
                </h3>
                <h4 className="text-blue-600 font-semibold mb-4 text-lg">
                  Google Developer Student Clubs
                </h4>
                <p className="text-gray-600 leading-relaxed text-lg">
                  Participated in the eighth season held at Bukalapak
                  headquarters in Jakarta, collaborating with fellow
                  participants to solve designated labs and enhance practical
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="bg-gradient-to-br from-blue-600 to-purple-700 rounded-3xl shadow-2xl p-8 md:p-12 text-white text-center">
            ...
            <p className="text-xl mb-8 text-blue-100 max-w-2xl mx-auto leading-relaxed">
              Ready to collaborate on exciting tech projects or discuss the
              latest in network infrastructure and cloud technologies?
            </p>

            <div className="flex flex-wrap justify-center gap-6">
              <a
                href="mailto:shareefmasyhur@gmail.com"
              ...
              <a
                href="https://www.linkedin.com/in/s8f"
                target="_blank"
              ...
              <a
                href="https://github.com/sharifmasyhur"
                target="_blank"
                rel="noopener noreferrer"
                className="group flex items-center px-8 py-4 bg-white bg-opacity-20 rounded-full hover:bg-white hover:text-blue-600 transition-all duration-300 hover:scale-105 backdrop-blur-sm"
              >
      ...
      <footer className="py-8 text-center text-white text-opacity-70 relative z-10">
        <div className="max-w-6xl mx-auto px-6">
          <p className="text-lg">
            &copy; 2025 Sharif Masyhur (Saf). Built with React & Passion for
            Technology.
          </p>
        </div>
      </footer>
